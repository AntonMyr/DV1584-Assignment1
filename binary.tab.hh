...
#line 125 "binary.tab.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const std::string v);
    ...
    static inline
    symbol_type
    make_OPENP (const std::string& v);

    static inline
    symbol_type
    make_CLOSEP (const std::string& v);
    ...
    static inline
    symbol_type
    make_CIRCUMFLEX (const std::string& v);
    ...
    static inline
    symbol_type
    make_MODULO (const std::string& v);
  ...
  parser::symbol_type
  parser::make_FLOAT (const std::string& v)
  {
  ...
  parser::symbol_type
  parser::make_OPENP (const std::string& v)
  {
    return symbol_type (token::OPENP, v);
  }

  parser::symbol_type
  parser::make_CLOSEP (const std::string& v)
  {
    return symbol_type (token::CLOSEP, v);
  }
  ...
  parser::symbol_type
  parser::make_CIRCUMFLEX (const std::string& v)
  {
    return symbol_type (token::CIRCUMFLEX, v);
  }
  ...
  parser::symbol_type
  parser::make_MODULO (const std::string& v)
  {
    return symbol_type (token::MODULO, v);
  }
